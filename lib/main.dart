...
void main() async {
  ...
  // New users see landing → register → home
  // Returning logged-in users go straight to home
  // Returning logged-out users see login
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildField('Business Name', 'Acme Corp', bizCtrl),
              const SizedBox(height: 12),
              _buildField('Contact Name', 'John Smith', nameCtrl),
              const SizedBox(height: 12),
              _buildField('Email', 'john@acme.com', emailCtrl,
                  type: TextInputType.emailAddress),
              const SizedBox(height: 12),
              _buildField('Phone', '+1 555 000 0000', phoneCtrl,
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          keyboardType: type,
          style: const TextStyle(
              fontFamily: 'Syne', fontSize: 13, color: AppColors.ink),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ...[0, 1, 2].map((i) => _sidebarItem(i)),
                          const Padding(
                            padding: EdgeInsets.only(left: 8, bottom: 6, top: 14),
                            child: Text('ACCOUNT',
                                style: TextStyle(
                                    fontFamily: 'Syne',
                                    fontSize: 9,
                    ...
                    child: Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        const Text('Upgrade to Pro',
                            style: TextStyle(fontFamily: 'Syne', fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white)),
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          Container(
            width: 26, height: 26,
            decoration: BoxDecoration(
                color: AppColors.accent, borderRadius: BorderRadius.circular(7)),
          ...
          child: SizedBox(
            ...
            child: Row(
              children: List.generate(4, (i) {
                final active = _tab == i;
                final showBadge = i == 1 && overdueCount > 0;
                return Expanded(
                  child: GestureDetector(
