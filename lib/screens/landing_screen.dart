...
class LandingScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        TextButton(
          ...
          child: Text('Sign in',
              style: TextStyle(fontFamily: 'Syne', fontSize: 13, color: Colors.white.withOpacity(0.6))),
        ),
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(width: 6),
            const Text('AI-powered invoice follow-ups',
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Container(
                    ...
                    child: const Text('Run Chasers (3)',
  ...
  Widget _PreviewInvoice(String client, String amount, String status, Color color) {
    return Container(
      ...
      child: Row(children: [
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(client, style: const TextStyle(fontFamily: 'Syne', fontSize: 12,
              fontWeight: FontWeight.w600, color: Colors.white)),
          Text(amount, style: const TextStyle(fontFamily: 'Syne', fontSize: 14,
              fontWeight: FontWeight.w800, color: Colors.white)),
        ])),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
          decoration: BoxDecoration(color: color.withOpacity(0.15), borderRadius: BorderRadius.circular(20)),
          child: Text(status, style: TextStyle(fontFamily: 'Syne', fontSize: 9,
  ...
  Widget _Features(bool isWide) {
    final items = [
      [Icons.auto_awesome, 'AI-powered messages',
        'Claude AI writes personalized follow-ups that sound human. Tone escalates from friendly to firm automatically.'],
      [Icons.send_outlined, 'Email, SMS & WhatsApp',
        'Reach clients on every channel. One-click bulk sending across all overdue invoices at once.'],
      [Icons.payments_outlined, 'Partial payments',
        'Track deposits and installments. See exactly how much is still owed on every invoice.'],
      [Icons.schedule_outlined, 'Chase sequences',
        'Gentle, Firm, or Urgent — automated follow-ups sent at exactly the right time.'],
      [Icons.people_outline, 'Client management',
        'Full client directory with invoice history, payment totals, and outstanding balances.'],
      [Icons.phone_iphone_outlined, 'Works everywhere',
        'iOS, Android, and Web from one codebase. Your data syncs across all devices.'],
    ];
          ...
          children: items.map((f) => ConstrainedBox(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(f[2] as String,
                    style: TextStyle(fontFamily: 'Syne', fontSize: 12,
                        color: Colors.white.withOpacity(0.45), height: 1.65)),
              ]),
            ),
          )).toList(),
        ),
        ...
        Wrap(
          ...
          children: steps.map((s) => ConstrainedBox(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(s[0], style: TextStyle(fontFamily: 'Syne', fontSize: 38,
                    fontWeight: FontWeight.w800,
                    color: Colors.white.withOpacity(0.07), letterSpacing: -2)),
                const SizedBox(height: 8),
                Text(s[1], style: const TextStyle(fontFamily: 'Syne', fontSize: 15,
                    fontWeight: FontWeight.w700, color: Colors.white)),
                const SizedBox(height: 7),
                Text(s[2], style: TextStyle(fontFamily: 'Syne', fontSize: 12,
                    color: Colors.white.withOpacity(0.45), height: 1.65)),
              ]),
            ),
          )).toList(),
        ...
        Wrap(
          ...
          children: [
            ...
            _PriceCard(context, 'Creator', '\$29', '/month', true,
                ['Unlimited invoices', 'Email + SMS + WhatsApp', 'AI message generation',
                  'Bulk chase runner', 'Custom sequences'],
                'Start Creator plan'),
            _PriceCard(context, 'Agency', '\$79', '/month', false,
                ['Everything in Creator', '5 team seats', '10 client profiles',
    ...
    return ConstrainedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: featured ? [BoxShadow(color: AppColors.accent.withOpacity(0.28),
              blurRadius: 28, offset: const Offset(0, 10))] : null,
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          if (featured)
            Container(
              ...
              decoration: BoxDecoration(color: Colors.white.withOpacity(0.2),
                  borderRadius: BorderRadius.circular(20)),
              child: const Text('MOST POPULAR', style: TextStyle(fontFamily: 'Syne', fontSize: 8,
                  fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1.0)),
            ),
          Text(name, style: TextStyle(fontFamily: 'Syne', fontSize: 13, fontWeight: FontWeight.w600,
              color: Colors.white.withOpacity(featured ? 0.7 : 0.45))),
          const SizedBox(height: 6),
          Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            Text(price, style: const TextStyle(fontFamily: 'Syne', fontSize: 34,
                fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: -1)),
            const SizedBox(width: 3),
            Padding(padding: const EdgeInsets.only(bottom: 5),
                child: Text(period, style: TextStyle(fontFamily: 'Syne', fontSize: 12,
                    color: Colors.white.withOpacity(0.4)))),
          ]),
          const SizedBox(height: 16),
          ...
          ...features.map((f) => Padding(
            ...
            child: Row(children: [
              Icon(Icons.check_circle_outline, size: 14,
                  color: featured ? Colors.white : AppColors.green),
              const SizedBox(width: 8),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: featured ? Colors.white : Colors.white.withOpacity(0.08),
                borderRadius: BorderRadius.circular(10),
              ),
              alignment: Alignment.center,
              child: Text(cta, style: TextStyle(fontFamily: 'Syne', fontSize: 13,
                  fontWeight: FontWeight.w700,
                  color: featured ? AppColors.accent : Colors.white)),
            ),
          ),
        ]),
      ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.symmetric(
            horizontal: BorderSide(color: AppColors.accent.withOpacity(0.18))),
      ),
      child: Column(children: [
    ...
    return Container(
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(width: 7),
          const Text('ChaseIt', style: TextStyle(fontFamily: 'Syne', fontSize: 14,
  ...
  Widget _Eyebrow(String text) => Container(
    ...
    decoration: BoxDecoration(border: Border.all(color: Colors.white.withOpacity(0.1)),
        borderRadius: BorderRadius.circular(20)),
    child: Text(text, style: TextStyle(fontFamily: 'Syne', fontSize: 10,
        fontWeight: FontWeight.w700, color: Colors.white.withOpacity(0.35), letterSpacing: 1.5)),
  );
  ...
  Widget _PrimaryBtn(String label, VoidCallback onTap) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(color: AppColors.accent, borderRadius: BorderRadius.circular(8)),
      child: Text(label, style: const TextStyle(fontFamily: 'Syne', fontSize: 13,
          fontWeight: FontWeight.w700, color: Colors.white)),
    ),
  );
}